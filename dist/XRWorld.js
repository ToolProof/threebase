...
class XRWorld extends World {
    constructor(container, targetType, rayColor) {
        super(container);
    ...
    showText(text) {
        ...
        const canvas = this.textSprite.material.map.image;
        canvas.width = 512;
        ...
        this.textSprite.material.map.needsUpdate = true;
